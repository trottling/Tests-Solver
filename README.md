...
Бот для VK, который принимает один или несколько снимков одного варианта теста, извлекает структуру заданий и возвращает финальный ответ с решением

## Возможности

- Работа через белосписочный VK
- Приём нескольких изображений как `photo` или `doc`
